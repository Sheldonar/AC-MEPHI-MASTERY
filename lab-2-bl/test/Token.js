...
describe("TheSecondLab.sol", () => {
    ...
    beforeEach(async () => {
        ...
        contractFactory = await ethers.getContractFactory("TheSecondLab");
    ...
    describe("Correct setup", () => {
        it("should be named 'TheSecondLab", async () => {
            const name = await contract.name();
            expect(name).to.equal("TheSecondLab");
        });
